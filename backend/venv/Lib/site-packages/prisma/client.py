...
SCHEMA_PATH = Path('C:/Users/Lenovo/Documents/GitHub/udansetu.ai/UdaanSetu.AI/backend/prisma/schema.prisma')
...
class Prisma(AsyncBasePrisma):
    ...
    assessmentresult: 'actions.AssessmentResultActions[models.AssessmentResult]'
    ...
    def __init__(
        ...
        *,
        ...
        self.assessmentresult = actions.AssessmentResultActions[models.AssessmentResult](self, models.AssessmentResult)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': 'C:/Users/Lenovo/Documents/GitHub/udansetu.ai/UdaanSetu.AI/backend/prisma/schema.prisma',
        }
...
class Batch:
    ...
    assessmentresult: 'AssessmentResultBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.assessmentresult = AssessmentResultBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class AssessmentResultBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher

    def create(
        self,
        data: types.AssessmentResultCreateInput,
        include: Optional[types.AssessmentResultInclude] = None
    ) -> None:
        self._batcher._add(
            method='create',
    ...
    def create_many(
        self,
        data: List[types.AssessmentResultCreateWithoutRelationsInput],
        *,
        skip_duplicates: Optional[bool] = None,
    ) -> None:
        if skip_duplicates and self._batcher._active_provider in CREATE_MANY_SKIP_DUPLICATES_UNSUPPORTED:
    ...
    def delete(
        self,
        where: types.AssessmentResultWhereUniqueInput,
        include: Optional[types.AssessmentResultInclude] = None,
    ) -> None:
        self._batcher._add(
            method='delete',
    ...
    def update(
        self,
        data: types.AssessmentResultUpdateInput,
        where: types.AssessmentResultWhereUniqueInput,
        include: Optional[types.AssessmentResultInclude] = None
    ) -> None:
        self._batcher._add(
    ...
    def upsert(
        self,
        where: types.AssessmentResultWhereUniqueInput,
        data: types.AssessmentResultUpsertInput,
        include: Optional[types.AssessmentResultInclude] = None,
    ) -> None:
        self._batcher._add(
            method='upsert',
    ...
    def update_many(
        self,
        data: types.AssessmentResultUpdateManyMutationInput,
        where: types.AssessmentResultWhereInput,
    ) -> None:
        self._batcher._add(
            method='update_many',
            model=models.AssessmentResult,
    ...
    def delete_many(
        self,
        where: Optional[types.AssessmentResultWhereInput] = None,
    ) -> None:
        self._batcher._add(
            method='delete_many',
            model=models.AssessmentResult,
