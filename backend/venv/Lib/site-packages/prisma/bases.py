...
class BaseAssessmentResult(_PrismaModel):
    __prisma_model__: ClassVar[Literal['AssessmentResult']] = 'AssessmentResult'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.AssessmentResultActions[_PrismaModelT]':
        from .client import get_client

        return actions.AssessmentResultActions[_PrismaModelT](client or get_client(), cls)
