        ...
        <div className="glass-card p-12 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-primary-indigo via-accent-cyan to-accent-teal bg-clip-text text-transparent animate-gradient">
                {t("assessment.completedTitle") || "Profile Generated!"}
            </h2>
            
            <p className="text-xl text-foreground/80 mb-10 max-w-2xl mx-auto leading-relaxed">
                Thank you! We have analyzed your responses and created your comprehensive bio-data profile. Our AI Mentor is now ready to guide you.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="/assessment/result">
                   <Button size="lg" className="shadow-lg hover:scale-105 transition-transform bg-gradient-to-r from-primary-indigo to-primary-navy border-0">
                       {t("assessment.viewReport") || "View Assessment Result"}
                   </Button>
                </a>
                <Button variant="outline" size="lg" onClick={handleRestart} className="hover:bg-accent/5 hover:text-accent border-accent/30">
                    {t("assessment.retakeAssessment") || "Retake"}
                </Button>
            </div>
          </div>
        </div>
